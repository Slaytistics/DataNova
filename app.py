...
# 🔧 Custom Styles (spacing fix, background, and theme)
st.markdown(
    """
    <style>
...
st.markdown(
    ...
    <div style="width: 100%; text-align: center; margin-bottom: 1rem;">
        <img src="https://i.imgur.com/4Hqe6a0.png" style="width: 100%; max-height: 250px; object-fit: cover;" />
    </div>
    """,
    unsafe_allow_html=True,
)
...
if uploaded_file:
    try:
        ...
        for role, msg in st.session_state.chat_history:
            ...
            st.markdown(f"<div class='{css_class}'><strong>{label}</strong><br>{msg}</div>", unsafe_allow_html=True)
